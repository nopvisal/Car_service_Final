                                ...
                                <div class="col-12">
                                    ...
                                    <div v-if="status == 'add'" class="mb-3">
                                        ...
                                        <input type="password" class="form-control"
                                            :class="{ 'is-invalid': errors.password, 'is-valid': FormData.password && !errors
                                                    .password }"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"
                                            :class="{ 'is-invalid': errors.language, 'is-valid': FormData.language && !errors
                                                    .language }"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"
                                            :class="{ 'is-invalid': errors.status, 'is-valid': FormData.status && !errors
                                                .status }"
                                            v-model="FormData.status" @change="validateField('status', FormData.status)">
