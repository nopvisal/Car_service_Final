                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <!-- Image Column (Left Side) with direct <img> tag -->
                            <div class="col-lg-6 d-none d-lg-block login-image-container">
                                <img src="{{ asset('dashboard-template/img/login-1390241095-2048x2048.jpg') }}" alt="Login Image">
                            </div>
